...
export const metadata = {
  title: "Contact Our Builder Team | DreamDen",
  description: "Get in touch with DreamDen today to schedule your home renovation consultation. Ask questions, request estimates, or find office locations.",
};

export default function ContactPage() {
  return (
    <article className="min-h-screen bg-white font-sans text-dark">
      {/* Banner */}
